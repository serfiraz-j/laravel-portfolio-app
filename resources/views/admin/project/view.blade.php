      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Project Section Data Table</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" aria-describedby="example2_info">
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
                ...
                <tr class="odd">                                  
                  ...
                  <td>{{$pr->sub_title}}</td>
                  <td>
                    <img src="{{$pr->image}}" width="150" height="150" alt=""></td>
                  <td>
                    
                    <form method="POST" action="{{route('admin.delete.project', $pr->id)}}">
                      @method('DELETE')
                      @csrf
                      <a href="{{route('admin.edit.project', $pr->id)}}" class="btn btn-primary">Edit</a>
